...
class Karyawan extends CI_Controller
{
	...
	public function data_produk()
	{
		...
		$this->load->view('templates/topbar', $data);
		$this->load->view('templates/sidebar', $data);
		$this->load->view('karyawan/data_produk', $data);
		$this->load->view('templates/footer');
	}
	...
	public function data_konsinyi()
	{
		...
		$this->load->view('templates/topbar', $data);
		$this->load->view('templates/sidebar', $data);
		$this->load->view('karyawan/data_konsinyi', $data);
		$this->load->view('templates/footer');
	}
	...
	public function data_persediaan()
	{
		...
		$this->load->view('templates/topbar', $data);
		$this->load->view('templates/sidebar', $data);
		$this->load->view('karyawan/data_persediaan', $data);
		$this->load->view('templates/footer');
	}
	...
	public function data_penjualan()
	{
		...
		$this->load->view('templates/topbar', $data);
		$this->load->view('templates/sidebar', $data);
		$this->load->view('karyawan/data_penjualan', $data);
		$this->load->view('templates/footer');
	}
